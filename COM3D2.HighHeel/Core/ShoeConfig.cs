...
public class ShoeConfig
{
    ...
    public void Deconstruct(
        ...
        out float toeL0AngleX,
        out float toeL01AngleX,
        out float toeL1AngleX,
        out float toeL11AngleX,
        out float toeL2AngleX,
        out float toeL21AngleX,
        out float toeL0AngleY,
        out float toeL01AngleY,
        out float toeL1AngleY,
        out float toeL11AngleY,
        out float toeL2AngleY,
        out float toeL21AngleY,
        out float toeL0AngleZ,
        out float toeL01AngleZ,
        out float toeL1AngleZ,
        out float toeL11AngleZ,
        out float toeL2AngleZ,
        out float toeL21AngleZ,
        ...
        out float toeR0AngleX,
        out float toeR01AngleX,
        out float toeR1AngleX,
        out float toeR11AngleX,
        out float toeR2AngleX,
        out float toeR21AngleX,
        out float toeR0AngleY,
        out float toeR01AngleY,
        out float toeR1AngleY,
        out float toeR11AngleY,
        out float toeR2AngleY,
        out float toeR21AngleY,
        out float toeR0AngleZ,
        out float toeR01AngleZ,
        out float toeR1AngleZ,
        out float toeR11AngleZ,
        out float toeR2AngleZ,
        out float toeR21AngleZ
    )
    {
